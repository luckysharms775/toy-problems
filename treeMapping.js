var Tree = function(value){
  ...
  Tree.prototype.map = function(callback) {
    ...
    mapTree.children = this.children.map(function(child){
...
console.log('Should be a tree with value of 20 and no children:', result.children[1].children[1].children[0]); // Tree { value: 20, children: [] }